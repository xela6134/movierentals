  ...
  return (
    <div className="flex flex-col items-center w-full justify-start default-background text-white p-8 gap-8">
      <div className="w-full border-2 border-white rounded-lg p-4 min-h-40">
        ...
        <p className="text-lg mb-1">I've decided to utilise this database, refine the data, add bits and pieces, then make a fullstack application with this.</p>
      </div>
      <div className="w-full border-2 border-white rounded-lg p-4 min-h-40">
      ...
      <div className="w-full border-2 border-white rounded-lg p-4 min-h-40">
        ...
        <a
          ...
          className="inline-flex items-center mt-1 px-4 py-2 bg-red-600 hover:bg-red-900 font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-75 transition-colors duration-200"
        >
      ...
      {loggedIn ? (
        ...
        <div className="text-xl">You are logged out - log in to leave a comment!</div>
      )}
    </div>
  )
}